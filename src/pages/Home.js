                            ...
                            <Slider {...settings}>
                                {lists.latest_release && lists.latest_release.map(latest_release => (
                                    <div>
                                        ...
                                        <a href="javascript:void(0);" class="external" data-audio='{"name": "", "artist": "Arebica Luna", "album": "Mummy", "url": "", "cover_art_url": ""}'>
                                            <img class="card-img-top" src={`${process.env.REACT_APP_IMAGE_URL}assets/thumbnail/320X320/${latest_release.thumbnail_320X320}`} alt="Card image cap"></img>
                                        </a>
                                        </div>
                                        <a href="artist-details.html" class="custom-card--link mt-2" tabindex="0"><h6 class="mb-0">{latest_release.name}</h6></a>
                            ...
                            <div className="section" key={playlists_data.id}>
                                <div className="heading">
                                    <div className="d-flex flex-wrap align-items-end">
                                        ...
                                        <Link to={"/songs/"+playlists_data.slug} className="btn btn-sm btn-pill btn-air btn-primary">View All</Link>
                                    </div>
                                    <hr />
                                </div>
                                <Slider {...settings2}>
                                    {playlists_data.value.map((data, i) => (
                                        <div>
                                            ...
                                            <a href="artist-details.html" class="custom-card--link mt-2" tabindex="0"><h6 class="mb-0">{data.name}</h6></a>
                                        </div>
                                    ))}
                                </Slider>
                            </div>
